	...
	def train(self, trainX, trainY, validX=None, validY=None, printTrainStats=True, printValStats=True, saveModel=False, loadModel=False, modelName=None):
		...
		for epoch in range(self.epochs):
			...
			if saveModel:
				...
				# FIXED: added allow_pickle=True to handle list of arrays with different shapes
				np.save(modelName, np.array(model, dtype=object), allow_pickle=True)
#                 np.save(modelName, model, allow_pickle=True)
				print("Model Saved (with allow_pickle=True)... ")
